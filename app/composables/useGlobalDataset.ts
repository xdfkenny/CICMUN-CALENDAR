...
const sections: GlobalSection[] = [
  {
    key: 'visa-free',
    title: 'Visa-Free',
    eyebrow: 'Easiest Entry',
    description: 'Countries where a Venezuelan passport can attend these short events without arranging a visa in advance.',
    advisory: null,
  ...
  },
  {
    key: 'e-visa',
    title: 'E-Visa',
    eyebrow: 'Extra Entry Step',
    description: 'Short-event destinations that still require an eVisa, eTA, visa on arrival, or a similar pre-travel approval step.',
    advisory: 'These trips are not visa-free. You still need to complete the relevant online or arrival visa process before traveling.',
  ...
  {
    key: 'visa-required',
    title: 'Regular Visa Required',
    eyebrow: 'More Planning Needed',
    description: 'Short events in countries where this passport still needs a regular visa before travel.',
    advisory: 'These destinations are shown for planning only. A standard visa process is still required before the event.',
    requiresVisaAction: true,
